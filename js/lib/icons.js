...
export const icons = {
  ...
  boot: P('<path d="M6 3.5v8.2l-3 3.1V19a1 1 0 0 0 1 1h15.5a1 1 0 0 0 1-1v-1.6c0-1-.6-1.9-1.6-2.2l-6-2V3.5z"/><path d="M6 7h5.5"/>'),
  glove: P('<path d="M9 21h6a3 3 0 0 0 3-3v-5.5a1.6 1.6 0 0 0-3.2 0V10a1.4 1.4 0 0 0-2.8 0V8.8a1.4 1.4 0 0 0-2.8 0V10a1.4 1.4 0 0 0-2.8 0v3.2L5 15.5V18a3 3 0 0 0 3 3z"/><path d="M9 21v-5"/>'),
};
